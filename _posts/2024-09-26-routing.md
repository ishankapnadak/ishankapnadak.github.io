...
$$
    \Pr \left[ \sum_j H_{ij} \geq 6n \right] &\leq \Pr \left[ \sum_j H_{ij} \geq (1 + 10n) \cdot \frac{1}{2} \right] \\
    &\leq exp \left( -\frac{100n^2}{2 + 10n} \cdot \frac{1}{2} \right) \approx e^{-5n} < e^{-4n}.
$$
